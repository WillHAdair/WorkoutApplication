...
class _WorkoutPageState extends State<WorkoutPage> {
  ...
  void onCheckBoxChanged(String exerciseName) {
    Provider.of<WorkoutData>(context, listen: false).checkOffExercise(widget.workoutName, exerciseName);
  }
  ...
  void createNewExercise() {
    List<CustomTextField> exercises = [
      CustomTextField(controller: exerciseNameController, hintText: "Exercise name", obscureText: false),
      CustomTextField(controller: exerciseWeightController, hintText: "Exercise weight", obscureText: false),
      CustomTextField(controller: exerciseSetsController, hintText: "Exercise sets", obscureText: false),
      CustomTextField(controller: exerciseRepsController, hintText: "Exercise reps", obscureText: false),
    ];
    showDialog(
      context: context,
      builder: (context) {
  ...
  void editExercise(String exerciseName) {
    Workout relevantWorkout = Provider.of<WorkoutData>(context, listen: false).getRelevantWorkout(widget.workoutName);
    Exercise relevantExercsise = Provider.of<WorkoutData>(context, listen: false).getRelevantExercise(
      relevantWorkout, 
      exerciseName
    );
    ...
    List<CustomTextField> exercises = [
      CustomTextField(controller: exerciseNameController, hintText: "New name", obscureText: false),
      CustomTextField(controller: exerciseWeightController, hintText: "New weight", obscureText: false),
      CustomTextField(controller: exerciseSetsController, hintText: "New sets", obscureText: false),
      CustomTextField(controller: exerciseRepsController, hintText: "New reps", obscureText: false),
    ];
    showDialog(
      context: context,
      builder: (context) {
  ...
  void delete(String exerciseName) {
    Provider.of<WorkoutData>(context, listen: false).deleteExercise(widget.workoutName, exerciseName);
      ...
      builder: (context, value, child) => Scaffold(
        ...
        body: ListView.builder(
          ...
          itemBuilder: (context, index) => ExerciseTile(
            ...
            onChanged: (val) => onCheckBoxChanged(value.getRelevantWorkout(widget.workoutName).exercises[index].name),
            onSettingsPress: () => editExercise(value.getRelevantWorkout(widget.workoutName).exercises[index].name),
            onDeletePress: () => deleteExercise(value.getRelevantWorkout(widget.workoutName).exercises[index].name),
          ),
        ),
      ),
    );
